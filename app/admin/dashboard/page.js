...
import { ArrowDownCircle, CheckCircle2, Clock, Gift, PiggyBank, TrendingUp, UserCheck, Users, UserX, Wallet } from "lucide-react";
...
export default function AdminDashboard({ darkMode }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      value: summary.totalRegistrationIncome,
      icon: <Wallet className="w-6 h-6" />,
      color: "bg-emerald-200",
    },
    {
      title: "Bonus Expenses",
      value: summary.totalBonusExpense,
    ...
    },
    {
      ...
      value: summary.totalWithdraws,
      icon: <ArrowDownCircle className="w-6 h-6" />,
      color: "bg-purple-200",
    },
    {
      title: "Pending Withdraws",
      value: summary.pendingWithdrawsCount,
      icon: <Clock className="w-6 h-6" />,
      color: "bg-amber-200",
    },
    {
      title: "Approved Users",
      value: summary.approvalUserCount,
      icon: <CheckCircle2 className="w-6 h-6" />,
      color: "bg-green-200",
    },
    {
      title: "Pending Users",
      value: summary.pendingUserCount,
      icon: <UserCheck className="w-6 h-6" />,
      color: "bg-yellow-200",
    },
    {
      title: "Rejected Users",
      value: summary.rejectedUserCount,
            ...
            <CardContent className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-2xl font-bold">
                  <CountUp end={card.value} duration={1.5} separator="," prefix={moneyKeys.includes(card.title) ? "BDT " : ""} />
                </h2>
              </div>
