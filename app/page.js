...
// import ShopPage from "./components/home/shop";
...
const Home = () => {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen overflow-x-hidden">
      ...
      {/* ===== MINIMAL PREMIUM ECOMMERCE HERO (B&W) ===== */}
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-28 text-center">

          {/* Brand Label */}
          <span className="inline-block mb-6 px-4 py-1 text-xs font-semibold tracking-widest uppercase border border-black text-black">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-black leading-tight">
            ...
            <span className="relative inline-block">
              In One Marketplace
              <span className="absolute left-0 bottom-1 w-full h-2 bg-black opacity-10 -z-10"></span>
            </span>
          </h1>

          {/* Subtext */}
          <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-600">
            A clean, reliable and scalable eCommerce platform for products,
            packages and verified sellers.
          </p>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-6">
            <Link
              href=""
              className="px-10 py-4 bg-black text-white font-semibold tracking-wide hover:bg-gray-900 transition"
            >
              Start Shopping
            </Link>
            ...
            <Link
              href=""
              className="px-10 py-4 border border-black text-black font-semibold tracking-wide hover:bg-black hover:text-white transition"
            >
              Become a Seller
            </Link>
          </div>
          ...
          {/* Trust Indicators */}
          <div className="mt-14 flex flex-wrap justify-center gap-10 text-sm text-gray-700">
